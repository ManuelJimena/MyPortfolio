    ...
    <main translate="no">
        <section className="skills" id="skills">
            ...
            <div className="serv-content">
                ...
                <div className="card">
                    <div className="box"> <i className='bx bxs-data'></i>
                        <div className="text">Database</div>
                        <p className="par-card">Node.js | Express.js | Mongo DB</p>
                    </div>
                </div>
                <div className="card">
                    <div className="box"> <i className='bx bxs-wrench'></i>
                        <div className="text">Tools</div>
                        <p className="par-card"> Vite | Tailwind | Adobe Photoshop | Sony Vegas | GitHub</p>
                    </div>
                </div>
            </div>
