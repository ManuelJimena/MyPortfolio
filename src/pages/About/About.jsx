...
<section className="about" id="about">
        <div className="about-img">
            <img src="https://res.cloudinary.com/dhjmt9vvq/image/upload/v1690112543/Portfolio/about_ls0yhi.png" alt="Profile picture"></img>
        </div>
        ...
        <div className="about-content">
            ...
            <details className="btn"><summary>Read More</summary>
